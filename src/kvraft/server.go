...
func (kv *KVServer) snapshoter(persister *raft.Persister) {
...
func (kv *KVServer) readSnapshot(kvState []byte) bool {
	if kvState == nil || len(kvState) < 1 {
		kv.appliedIndex = 0
